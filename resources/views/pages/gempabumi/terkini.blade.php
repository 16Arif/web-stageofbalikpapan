<x-layouts.app>
    <x-slot:title>Gempa Terkini - Stasiun Geofisika Balikpapan</x-slot:title>

    @php
        // Menyesuaikan dengan variabel dari controller atau fallback jika API gagal
        $gempaTerkini = $latestEarthquake ?? [
            'date' => '21 April 2026',
            'time' => '02:02:20 WIB',
            'magnitude' => '5.9',
            'depth' => '14 km',
    ...
    <section class="py-12 bg-slate-50">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="mb-8 flex items-center gap-4">
                ...
                <h3 class="text-xl font-bold text-slate-900 uppercase tracking-tight">Kejadian Terkini (M > 5.0)</h3>
            </div>
            ...
            <div
                ...
                <div class="lg:col-span-2 relative group">
                    <div
                        ...
                        <img src="{{ $gempaTerkini['shakemap'] }}"
                            alt="Peta tingkat guncangan gempabumi terbaru"
                            ...
                            @forelse ($listGempa as $data)
                                <tr class="hover:bg-slate-50/80 transition-colors">
                                    ...
                                    <td class="px-6 py-5 text-center">
                                        <span
                                            class="inline-flex items-center justify-center size-9 rounded-lg {{ $data['mag'] >= 5 ? 'bg-red-50 text-red-600' : 'bg-slate-100 text-slate-600' }} font-black text-sm">
                                            {{ $data['mag'] }}
                                        </span>
                                    </td>
