...
<div class="space-y-6">
    ...
    @if ($this->activeMap && $this->activeMap->map_image_url)
        <div x-data="{ isFullscreen: false }" class="relative max-w-5xl mx-auto w-full">
            ...
            >
                <!-- Watermark (Only shown in Fullscreen) -->
                <div 
                    x-show="isFullscreen" 
                    x-transition 
                    class="absolute inset-0 flex items-center justify-center pointer-events-none select-none overflow-hidden z-10"
                >
                    <span class="text-4xl md:text-6xl font-extrabold text-white/10 -rotate-12 tracking-wider uppercase select-none">
                ...
                >
                    <img 
                        ...
                        alt="Peta Sambaran Petir - {{ $this->activeMap->periode_bulan_tahun }}" 
                        draggable="false"
...
<!-- Alpine mapZoomer Component Script -->
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('mapZoomer', (initialUrl) => ({
            ...
            initPanzoom() {
                ...
                area.parentElement.addEventListener('wheel', (e) => {
                    e.preventDefault();
