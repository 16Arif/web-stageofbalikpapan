<x-layouts.app>
        ...
        <ol class="flex items-center space-x-2 text-sm text-gray-700">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <span class="text-gray-900 font-medium">Info Petir</span>
                </div>
            </li>
        </ol>
    </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-6xl mx-auto px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 gap-12 items-start">
                    <div>
                        ...
                        <div class="text-slate-600 leading-relaxed space-y-4 text-sm md:text-base">
                            ...
                            <p>
                                Proses ini menghasilkan kilatan cahaya yang sangat terang (kilat) dan diikuti oleh suara
                                ledakan yang dahsyat (guntur) akibat pemuaian udara secara mendadak yang dilewati oleh
                    ...
                    <div class="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden">
                        ...
                        <div class="absolute -right-4 -bottom-4 opacity-10">
                            <svg class="size-32" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="mb-20">
                <h3 class="text-2xl font-black text-slate-900 mb-8 text-center uppercase tracking-tight">Langkah
                    Keselamatan (Mitigasi)</h3>
                ...
                <div class="relative z-10 max-w-2xl mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                        ...
                        <a href="{{ route('pelayanan') }}"
                            ...
                            Permintaan Data Presisi
                        </a>
                    </div>
                </div>
                <div
                    class="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 size-96 bg-indigo-500 rounded-full blur-3xl opacity-50">
                </div>
                <div
                    class="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/2 size-64 bg-blue-400 rounded-full blur-3xl opacity-30">
                </div>
            </div>
