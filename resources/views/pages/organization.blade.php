<x-layouts.app>
    ...
    <section class="bg-slate-900 py-16">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 text-center">
            <h2 class="text-indigo-400 font-bold uppercase tracking-widest text-sm mb-3">Manajemen</h2>
            <h1 class="text-3xl md:text-5xl font-extrabold text-white">Struktur Organisasi</h1>
            <p class="mt-4 text-slate-400">SDM Unggul untuk Pelayanan Data Geofisika yang
                Terpercaya.</p>
        </div>
    </section>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid sm:grid-cols-2 gap-4">
                        ...
                        @foreach ($operasional as $name)
                            <div
                                class="bg-white p-4 rounded-xl shadow-sm border border-slate-200 flex items-center gap-3 group hover:border-red-200 transition-colors">
                                <div
                                    class="size-8 rounded-lg bg-slate-50 flex items-center justify-center text-slate-400 group-hover:bg-red-50 group-hover:text-red-500 transition-colors">
