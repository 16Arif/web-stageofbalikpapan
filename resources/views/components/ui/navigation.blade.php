                                 ...
                                 <div class="grid grid-cols-2 gap-4">
                                     <div>
                                         ...
                                         <a href="{{ route('geofisika.petir') }}"
                                             class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 rounded-lg">Sambaran Petir</a>
                                     ...
                                     <div>
                                         ...
                                         <a href="{{ route('geofisika.peta-petir') }}"
                                             class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 rounded-lg">Peta Kejadian Petir</a>
                                         <a href="{{ route('geofisika.kerapatan-petir') }}"
                                             class="block px-4 py-2 text-sm text-gray-700 hover:bg-indigo-50 hover:text-indigo-600 rounded-lg">Peta Kerapatan Petir</a>
                                     </div>
                                 </div>
                             </div>
                         </div>
